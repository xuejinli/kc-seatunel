...
public class Float4Converter implements Converter<Float4Vector> {
    @Override
    public Object convert(int rowIndex, Float4Vector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.FLOAT4 == type;
    }
}
