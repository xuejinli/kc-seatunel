...
public class TimeMicroConverter implements Converter<TimeMicroVector> {
    @Override
    public Object convert(int rowIndex, TimeMicroVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.TIMEMICRO == type;
    }
}
