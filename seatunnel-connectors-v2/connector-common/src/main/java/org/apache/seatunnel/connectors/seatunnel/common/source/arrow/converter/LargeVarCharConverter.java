...
public class LargeVarCharConverter implements Converter<LargeVarCharVector> {
    @Override
    public Object convert(int rowIndex, LargeVarCharVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex).toString();
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.LARGEVARCHAR == type;
    }
}
