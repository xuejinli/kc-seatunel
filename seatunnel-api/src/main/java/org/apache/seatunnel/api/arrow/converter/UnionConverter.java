...
import org.apache.seatunnel.shade.org.apache.arrow.vector.complex.UnionVector;
import org.apache.seatunnel.shade.org.apache.arrow.vector.types.Types;

public class UnionConverter implements Converter<UnionVector> {
    @Override
    public Object convert(int rowIndex, UnionVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.UNION == type;
    }
}
