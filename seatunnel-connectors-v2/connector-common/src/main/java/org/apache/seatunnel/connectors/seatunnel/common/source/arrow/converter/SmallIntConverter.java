...
public class SmallIntConverter implements Converter<SmallIntVector> {

    @Override
    public Object convert(int rowIndex, SmallIntVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.SMALLINT == type;
    }
}
