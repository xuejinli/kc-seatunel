...
import org.apache.seatunnel.connectors.seatunnel.file.juicefs.config.JuicefsConfigOptions;

import com.google.auto.service.AutoService;

@AutoService(Factory.class)
public class JuicefsFileSinkFactory extends BaseMultipleTableFileSinkFactory {
    @Override
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ReadonlyConfig finalConfig = context.getOptions();
        CatalogTable catalogTable = context.getCatalogTable();
        return () -> new JuicefsFileSink(catalogTable, finalConfig);
    }
}
