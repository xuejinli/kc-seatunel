...
import org.apache.seatunnel.shade.org.apache.arrow.vector.UInt8Vector;
import org.apache.seatunnel.shade.org.apache.arrow.vector.types.Types;

public class UInt8Converter implements Converter<UInt8Vector> {
    @Override
    public Object convert(int rowIndex, UInt8Vector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.UINT8 == type;
    }
}
