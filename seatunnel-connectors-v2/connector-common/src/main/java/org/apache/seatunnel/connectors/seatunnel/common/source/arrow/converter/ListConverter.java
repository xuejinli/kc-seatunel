...
public class ListConverter implements Converter<ListVector> {
    ...
    @Override
    public Object convert(int rowIndex, ListVector fieldVector, List<Function> genericsConvert) {
                            ...
                            if (item instanceof LocalDateTime) {
                                LocalDateTime localDateTime =
                                        ((LocalDateTime) item)
                                                ...
                                                .toLocalDateTime();
                                return genericsConvert.get(0).apply(localDateTime);
                            } else {
                                return genericsConvert.get(0).apply(item);
                            }
                        })
