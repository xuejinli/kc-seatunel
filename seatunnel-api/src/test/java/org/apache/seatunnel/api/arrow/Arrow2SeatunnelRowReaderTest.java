...
package org.apache.seatunnel.api.arrow;
...
@Slf4j
public class Arrow2SeatunnelRowReaderTest {
    ...
    public void testSeatunnelRow() throws Exception {
        try (ByteArrayOutputStream out = new ByteArrayOutputStream();
            ...
            try (Arrow2SeatunnelRowReader reader =
                    new Arrow2SeatunnelRowReader(out.toByteArray(), getSeatunnelRowType(true))
                            .readArrow()) {
    ...
    public void testConvertArrowSpeed() throws Exception {
        ...
        try (RootAllocator rootAllocator = new RootAllocator(Integer.MAX_VALUE);
            ...
            try (Arrow2SeatunnelRowReader reader =
                    new Arrow2SeatunnelRowReader(out.toByteArray(), seatunnelRowType).readArrow()) {
                while (reader.hasNext()) {
                    rows.add(reader.next());
                }
                stopwatch.stop();
