                        ...
                        public void run() {
                            ...
                            try {
                                ...
                                while (!eos.get()) {
                                    ...
                                    if (!eos.get()) {
                                        Arrow2SeatunnelRowReader rowBatch =
                                                new Arrow2SeatunnelRowReader(
                                                                nextResult.getRows(),
                                                                seaTunnelRowType)
                                                        .readArrow();
        ...
        if (deserializeArrowToRowBatchAsync && asyncThreadStarted) {
            ...
            try {
                ...
                if (!eos.get() && (rowBatch == null || !rowBatch.hasNext())) {
                    ...
                    if (!eos.get()) {
                        rowBatch =
                                new Arrow2SeatunnelRowReader(nextResult.getRows(), seaTunnelRowType)
                                        .readArrow();
                    }
                }
                hasNext = !eos.get();
