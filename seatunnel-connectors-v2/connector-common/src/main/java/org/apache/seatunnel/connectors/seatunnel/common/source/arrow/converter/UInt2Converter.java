...
import org.apache.seatunnel.shade.org.apache.arrow.vector.UInt2Vector;
import org.apache.seatunnel.shade.org.apache.arrow.vector.types.Types;

public class UInt2Converter implements Converter<UInt2Vector> {
    @Override
    public Object convert(int rowIndex, UInt2Vector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.UINT2 == type;
    }
}
