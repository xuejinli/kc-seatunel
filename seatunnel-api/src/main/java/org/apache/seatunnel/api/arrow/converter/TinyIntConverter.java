...
public class TinyIntConverter implements Converter<TinyIntVector> {

    @Override
    public Object convert(int rowIndex, TinyIntVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.TINYINT == type;
    }
}
