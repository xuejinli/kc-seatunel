...
public class VarBinaryConverter implements Converter<VarBinaryVector> {
    @Override
    public Object convert(int rowIndex, VarBinaryVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.VARBINARY == type;
    }
}
