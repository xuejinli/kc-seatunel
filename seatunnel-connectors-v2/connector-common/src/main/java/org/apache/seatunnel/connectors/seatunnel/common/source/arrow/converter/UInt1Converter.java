...
import org.apache.seatunnel.shade.org.apache.arrow.vector.UInt1Vector;
import org.apache.seatunnel.shade.org.apache.arrow.vector.types.Types;

public class UInt1Converter implements Converter<UInt1Vector> {
    @Override
    public Object convert(int rowIndex, UInt1Vector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.UINT1 == type;
    }
}
