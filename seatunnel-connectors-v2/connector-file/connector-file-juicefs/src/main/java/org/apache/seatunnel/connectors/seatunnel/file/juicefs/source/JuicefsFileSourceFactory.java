...
public class JuicefsFileSourceFactory implements TableSourceFactory {
    @Override
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>) new JuicefsFileSource(context.getOptions());
    }
    ...
    public Class<? extends SeaTunnelSource> getSourceClass() {
        return JuicefsFileSource.class;
    }
}
