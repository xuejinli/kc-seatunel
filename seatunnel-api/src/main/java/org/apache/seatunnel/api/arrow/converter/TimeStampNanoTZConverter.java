...
public class TimeStampNanoTZConverter implements Converter<TimeStampNanoTZVector> {
    @Override
    public Object convert(int rowIndex, TimeStampNanoTZVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.TIMESTAMPNANOTZ == type;
    }
}
