...
import org.apache.seatunnel.shade.org.apache.arrow.vector.TimeSecVector;
import org.apache.seatunnel.shade.org.apache.arrow.vector.types.Types;

public class TimeSecConverter implements Converter<TimeSecVector> {
    @Override
    public Object convert(int rowIndex, TimeSecVector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.TIMESEC == type;
    }
}
