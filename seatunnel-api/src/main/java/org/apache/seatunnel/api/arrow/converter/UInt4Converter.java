...
public class UInt4Converter implements Converter<UInt4Vector> {
    @Override
    public Object convert(int rowIndex, UInt4Vector fieldVector) {
        return fieldVector.isNull(rowIndex) ? null : fieldVector.getObject(rowIndex);
    }

    @Override
    public boolean support(Types.MinorType type) {
        return Types.MinorType.UINT4 == type;
    }
}
